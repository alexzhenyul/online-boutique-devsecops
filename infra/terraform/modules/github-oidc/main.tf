...
# Get the latest GitHub Actions OIDC thumbprint
...
# For this template, we give PowerUserAccess + EKS Admin
# In production, scope this down tightly!
...
# Allow describing clusters (needed for update-kubeconfig)
